...
fl = open("har.csv","w+")
fl.write("sn"+","+"st"+","+"dist"+","+"stn"+","+"rf"+"\n")
url = "http://aws.imd.gov.in:8091/AWS/dataview.php?a=AWSAGRO&b=HARYANA&c=ALL_DISTRICT&d=ALL_STATION&e=2024-09-04&f=2024-09-05&g=ALL_HOUR&h=ALL_MINUTE"
